...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c22 = function(op, term, proximity, boost) {
              var result = {
                'term': term,
                'quoted': true,
                'regex' : false,
      ...
      peg$c24 = function(op, term, similarity, boost) {
              var result = {
                'term': term.label,
                'quoted': false,
                'regex': false,
      ...
      peg$c27 = function(sequence) { return '\\' + sequence; },
      peg$c28 = ".",
      peg$c29 = peg$literalExpectation(".", false),
      peg$c30 = /^[^ \t\r\n\f{}()"\/\^~[\]]/,
      peg$c31 = peg$classExpectation([" ", "\t", "\r", "\n", "\f", "{", "}", "(", ")", "\"", "/", "^", "~", "[", "]"], true, false),
      peg$c32 = function(term) {
              return term.join('');
          },
      ...
      peg$c43 = function(char) { return char; },
      peg$c44 = "+",
      ...
      peg$c74 = function(proximity) {
              return proximity;
          },
      peg$c75 = function(boost) {
              return boost;
          },
      peg$c76 = function(fuzziness) {
              return fuzziness == '' || fuzziness == null ? 0.5 : fuzziness;
          },
      peg$c77 = "0.",
      peg$c78 = peg$literalExpectation("0.", false),
      peg$c79 = /^[0-9]/,
      ...
      peg$c89 = function(operator) {
              return operator;
          },
      peg$c90 = "OR NOT",
      peg$c91 = peg$literalExpectation("OR NOT", false),
      peg$c92 = "AND NOT",
      peg$c93 = peg$literalExpectation("AND NOT", false),
      peg$c94 = "OR",
      peg$c95 = peg$literalExpectation("OR", false),
      peg$c96 = "AND",
      peg$c97 = peg$literalExpectation("AND", false),
      peg$c98 = "NOT",
