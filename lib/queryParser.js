...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c21 = function(parsername, fieldname, term) {
         		var parserexp = {
              	'field': fieldname.label,
                  'fieldLocation': fieldname.location,
                  'parser': parsername.label
              }

              for(var key in term)
                  parserexp[key] = term[key];

              return parserexp
         },
      peg$c22 = function(fieldname) {
              return {
                label: fieldname.label,
                location: fieldname.location
              }
          },
      peg$c23 = function(op, term, proximity, boost) {
              var result = {
                'term': term,
                'quoted': true,
                'regex' : false,
      ...
      peg$c75 = function(proximity) {
              return proximity;
          },
      peg$c76 = function(boost) {
              return boost;
          },
      peg$c77 = function(fuzziness) {
      ...
      peg$c91 = "OR NOT",
      peg$c92 = peg$literalExpectation("OR NOT", false),
      peg$c93 = "AND NOT",
      peg$c94 = peg$literalExpectation("AND NOT", false),
      peg$c95 = "OR",
      peg$c96 = peg$literalExpectation("OR", false),
      peg$c97 = "AND",
      peg$c98 = peg$literalExpectation("AND", false),
      peg$c99 = "NOT",
      peg$c100 = peg$literalExpectation("NOT", false),
      peg$c101 = "||",
